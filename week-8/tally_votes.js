...
// What did you learn about iterating over nested objects in JavaScript?
  // It's just a matter of accessing the correct property and value that you want
// Were you able to find useful methods to help you with this?
  // Since this challenge required a considerable amount of looping, we were pretty limited when it came to choosing iteration methods; it's not like in Ruby where there are a buttload of methods that do different things; in JS you gotta work with the for...in loops to do what you want.
// What concepts were solidified in the process of working through this challenge?
  // Targeting elements in nested objects, assigning properties and values from one object to another
